...
%   read_env_core     - Read the environmental file
...
%   read_shd_bin      - Read TL surfaces from a binary Bellhop/Kraken .SHD file
...
%   equally_spaced    - routine to see if the vector x is composed of roughly equally spaced
