...
#ifndef INCLUDE_SMALLBETS_PLUGINS_INTERACTION_OCEANPARAMETERS_OCEANMAP_H_
...
class OceanMap {
 public:
    ...
    explicit OceanMap(const smallbets::msgs::Ocean &Ocean);
    smallbets::msgs::Ocean proto();
    double param_at(const double &x, const double &y,const double &z);
...
#endif // INCLUDE_SMALLBETS_PLUGINS_INTERACTION_OCEANPARAMETERS_OCEANMAP_H_
